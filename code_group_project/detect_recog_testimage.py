...
img = cv2.imread('/home/medievalvn/Documents/USTH_project/group_project/facenet-pytorch-glint360k-master/face.jpg')
img_rgb = img[:, :, ::-1]
...
if faces.shape[0] > 0:
    ...
    # Now you have the face embedding for further processing
    ...
    print("Detected face with bounding box saved to face_detected.jpg")
